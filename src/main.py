...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', type=str, default='pomcp', help='The file name of algorithm configuration (without JSON extension)')
    parser.add_argument('--env', type=str, default='RockSample-7x8.POMDP', help='The name of environment\'s config file')
